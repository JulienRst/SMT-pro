        ...
        <Space className={styles.contactBlockContainer}>
          <a href={`tel:${config.phone}`}>
            <Space className={styles.contactBlock} direction="vertical" size="medium" align="middle">
              <ImgWithFallBack src={images.Contact.Phone} alt={t('contact.phone', { phone: config.dspPhone })} />
              <p>{t('contact.phone', { phone: config.dspPhone })}</p>
            </Space>
          </a>
          <Space className={styles.contactBlock} direction="vertical" size="medium" align="middle">
            <ImgWithFallBack src={images.Contact.Factory} alt={t('contact.factory')} />
            <p>{t('contact.factory')}</p>
          </Space>
          <a href={`mailto:${config.email}`}>
            <Space className={styles.contactBlock} direction="vertical" size="medium" align="middle">
              <ImgWithFallBack src={images.Contact.Email} alt={config.email} />
              <br />
                <p>{config.email}</p>
            </Space>
          </a>
